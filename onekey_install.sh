...
download_pc(){
    ...
    wget https://raw.githubusercontent.com/slobys/proxypool/master/config.yaml
    wget https://raw.githubusercontent.com/slobys/proxypool/master/source.yaml
...
start_menu(){
    ...
    green " 网站：www.naiyou001.tk"
    green " Youtube频道：一瓶奶油"
    green "======================================="
    green "1. 一键安装免费节点爬虫"
    red "2. 卸载爬虫"
    yellow "0. 退出脚本"
